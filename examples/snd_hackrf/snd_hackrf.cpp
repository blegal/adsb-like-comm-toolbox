...
int main(int argc, char* argv[])
{
    ...
    vector<uint8_t> vec_crc (           (payload + 4)       );
    vector<uint8_t> vec_bits(      (8 * (payload + 4))      );
    vector<uint8_t> vec_sync(     ((8 * (payload + 4)) + 8) );
    vector< int8_t> vec_ppm ( 2 * ((8 * (payload + 4)) + 8) );
    vector< int8_t> vec_up  ( 4 * ((8 * (payload + 4)) + 8) );
    vector< int8_t> vec_iq  ( 8 * ((8 * (payload + 4)) + 8) );
