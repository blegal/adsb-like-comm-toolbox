...
SoundSystem::SoundSystem( std::vector<int16_t>& buffer ) :
    liste(),
    _fName( "None" )
{
...
void SoundSystem::update_ref(std::vector<int16_t>& buffer)
{
    liste.at(0)->update( buffer );
}


void SoundSystem::update_mod(std::vector<int16_t>& buffer)
{
