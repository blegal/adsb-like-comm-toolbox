...
#
# Generated by export_simulation on Thu Mar 25 14:01:03 CET 2021
#
################################################################################
...
'-reset_run' switch to the './my_module_0.sh' script.

./my_module_0.sh -reset_run
...
./my_module_0.sh -noclean_files

For more information on the script, please type './my_module_0.sh -help'.
