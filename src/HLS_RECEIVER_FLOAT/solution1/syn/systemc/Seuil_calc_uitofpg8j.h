...
// ==============================================================
#ifndef __Seuil_calc_uitofpg8j__HH__
#define __Seuil_calc_uitofpg8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Seuil_calc_uitofpg8j) {
    ...
    SC_CTOR(Seuil_calc_uitofpg8j):  ACMP_uitofp_U ("ACMP_uitofp_U") {
