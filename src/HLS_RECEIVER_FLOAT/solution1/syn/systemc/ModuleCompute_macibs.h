...
// ==============================================================
#ifndef __ModuleCompute_macibs__HH__
#define __ModuleCompute_macibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ModuleCompute_macibs) {
    ...
    SC_CTOR(ModuleCompute_macibs):  simcore_mac_0_U ("simcore_mac_0_U") {
