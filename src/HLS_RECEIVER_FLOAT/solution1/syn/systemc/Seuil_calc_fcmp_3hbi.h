...
// ==============================================================
#ifndef __Seuil_calc_fcmp_3hbi__HH__
#define __Seuil_calc_fcmp_3hbi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Seuil_calc_fcmp_3hbi) {
    ...
    SC_CTOR(Seuil_calc_fcmp_3hbi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
