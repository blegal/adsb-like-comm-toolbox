...
#ifndef _my_module_HH_
#define _my_module_HH_
...
struct my_module : public sc_module {
    ...
    sc_signal< sc_logic > grp_Detecteur_fu_226_e_read;
    sc_signal< sc_lv<8> > grp_Detecteur_fu_226_s_din;
    sc_signal< sc_logic > grp_Detecteur_fu_226_s_write;
