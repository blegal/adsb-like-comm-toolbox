...
architecture behav of Detecteur is 
    ...
    signal grp_Seuil_calc_fu_100_e_read : STD_LOGIC;
    signal grp_Seuil_calc_fu_100_detect_din : STD_LOGIC;
    signal grp_Seuil_calc_fu_100_detect_write : STD_LOGIC;
    signal grp_trames_separ_fu_114_e_read : STD_LOGIC;
    signal grp_trames_separ_fu_114_detect_dout : STD_LOGIC;
    signal grp_trames_separ_fu_114_detect_read : STD_LOGIC;
    signal grp_trames_separ_fu_114_s_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_trames_separ_fu_114_s_write : STD_LOGIC;
...
begin
    grp_Seuil_calc_fu_100 : component Seuil_calc
    port map (
    ...
    grp_trames_separ_fu_114 : component trames_separ
    port map (
    ...
    detect_1_din <= (0=>grp_Seuil_calc_fu_100_detect_din, others=>'-');
    e_read <= grp_DOUBLEUR_U_fu_130_e_read;
    grp_trames_separ_fu_114_detect_dout <= detect_1_dout(0);
    s_din <= grp_trames_separ_fu_114_s_din;
    s_write <= grp_trames_separ_fu_114_s_write;
end behav;
