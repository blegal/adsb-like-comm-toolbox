#include "DetecteurINTER_AVX2.hpp"

#ifdef __AVX2__
    #include <immintrin.h>
#endif

DetecteurINTER_AVX2::DetecteurINTER_AVX2() : Detecteur(1)
{

}

void DetecteurINTER_AVX2::execute(float *buffer){

}


void DetecteurINTER_AVX2::execute(std::vector<float>* iBuffer, std::vector<float>* oBuffer)
{
#ifdef __AVX2__
