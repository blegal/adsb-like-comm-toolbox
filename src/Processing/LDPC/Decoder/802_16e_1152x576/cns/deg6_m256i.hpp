...
#ifndef _DEG6_HEADER_
#define _DEG6_HEADER_
...
template <
  int posVN1, int posVN2, int posVN3, int posVN4, int posVN5, int posVN6, 
  int cRota1, int cRota2, int cRota3, int cRota4, int cRota5, int cRota6, 
  int QC_Z, /* ON VIENT DE RAJOUTER QC_Z */
  int PART
>
inline void __attribute__((__always_inline__)) process_cn_deg6( int8_t var_nodes[], TYPE var_mesgs[], unsigned char p1, unsigned char p2 )
{
	...
	//
	sign_somme = vect_fixed::xorb(sign_somme, vect_fixed::set1s<char, TYPE>( 0x40 ));
...
>
inline TYPE __attribute__((__always_inline__)) process_cn_deg6( int8_t var_nodes[]  )
{
