...
// ==============================================================
#ifndef __Seuil_calc1_mul_mfYi__HH__
#define __Seuil_calc1_mul_mfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Seuil_calc1_mul_mfYi) {
    ...
    SC_CTOR(Seuil_calc1_mul_mfYi):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
