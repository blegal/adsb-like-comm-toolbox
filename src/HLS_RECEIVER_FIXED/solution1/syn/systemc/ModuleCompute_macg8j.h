...
// ==============================================================
#ifndef __ModuleCompute_macg8j__HH__
#define __ModuleCompute_macg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ModuleCompute_macg8j) {
    ...
    SC_CTOR(ModuleCompute_macg8j):  simcore_mac_1_U ("simcore_mac_1_U") {
