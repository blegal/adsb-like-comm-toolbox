...
// ==============================================================
#ifndef __Seuil_calc1_mul_meOg__HH__
#define __Seuil_calc1_mul_meOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Seuil_calc1_mul_meOg) {
    ...
    SC_CTOR(Seuil_calc1_mul_meOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
