...
const sc_logic my_module1::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic my_module1::ap_const_logic_0 = sc_dt::Log_0;

my_module1::my_module1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    grp_Detecteur1_fu_226 = new Detecteur1("grp_Detecteur1_fu_226");
    grp_Detecteur1_fu_226->e_dout(mod2dbl_1_dout);
    grp_Detecteur1_fu_226->e_empty_n(mod2dbl_1_empty_n);
    grp_Detecteur1_fu_226->e_read(grp_Detecteur1_fu_226_e_read);
    grp_Detecteur1_fu_226->s_din(grp_Detecteur1_fu_226_s_din);
    grp_Detecteur1_fu_226->s_full_n(det2dow_1_full_n);
    grp_Detecteur1_fu_226->s_write(grp_Detecteur1_fu_226_s_write);
    grp_Detecteur1_fu_226->clock(clock);
    grp_Detecteur1_fu_226->reset(reset);
    ...
    mod2dbl_1_fifo_U->if_read(grp_Detecteur1_fu_226_e_read);
    ...
    det2dow_1_fifo_U->if_din(grp_Detecteur1_fu_226_s_din);
    det2dow_1_fifo_U->if_full_n(det2dow_1_full_n);
    det2dow_1_fifo_U->if_write(grp_Detecteur1_fu_226_s_write);
    ...
    apTFilenSS << "my_module1_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, grp_Detecteur1_fu_226_e_read, "grp_Detecteur1_fu_226_e_read");
    sc_trace(mVcdFile, grp_Detecteur1_fu_226_s_din, "grp_Detecteur1_fu_226_s_din");
    sc_trace(mVcdFile, grp_Detecteur1_fu_226_s_write, "grp_Detecteur1_fu_226_s_write");
    ...
    mHdltvinHandle.open("my_module1.hdltvin.dat");
    mHdltvoutHandle.open("my_module1.hdltvout.dat");
}

my_module1::~my_module1() {
    if (mVcdFile) 
