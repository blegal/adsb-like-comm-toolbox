...
#ifndef _Detecteur1_HH_
#define _Detecteur1_HH_
...
struct Detecteur1 : public sc_module {
    // Port declarations 8
    sc_in_clk clock;
    ...
    // Module declarations
    Detecteur1(sc_module_name name);
    SC_HAS_PROCESS(Detecteur1);
    ...
    sc_signal< sc_logic > grp_Seuil_calc1_fu_100_e_read;
    sc_signal< sc_logic > grp_Seuil_calc1_fu_100_detect_din;
    sc_signal< sc_logic > grp_Seuil_calc1_fu_100_detect_write;
    sc_signal< sc_logic > grp_trames_separ1_fu_114_e_read;
    sc_signal< sc_logic > grp_trames_separ1_fu_114_detect_dout;
    sc_signal< sc_logic > grp_trames_separ1_fu_114_detect_read;
    sc_signal< sc_lv<8> > grp_trames_separ1_fu_114_s_din;
    sc_signal< sc_logic > grp_trames_separ1_fu_114_s_write;
    ...
    void thread_e_read();
    void thread_grp_trames_separ1_fu_114_detect_dout();
    void thread_s_din();
    void thread_s_write();
};
