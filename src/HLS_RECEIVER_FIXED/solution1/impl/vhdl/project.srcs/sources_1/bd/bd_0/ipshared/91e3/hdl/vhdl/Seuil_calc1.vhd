...
architecture behav of Seuil_calc1 is 
    ...
    signal grp_Seuil_calc1_do_gen_fu_56_e_read : STD_LOGIC;
    signal grp_Seuil_calc1_do_gen_fu_56_detect_din : STD_LOGIC;
    signal grp_Seuil_calc1_do_gen_fu_56_detect_write : STD_LOGIC;

    component Seuil_calc1_do_gen IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        e_dout : IN STD_LOGIC_VECTOR (7 downto 0);
...
begin
    grp_Seuil_calc1_do_gen_fu_56 : component Seuil_calc1_do_gen
    port map (
        ap_clk => clock,
        ap_rst => reset,
        e_dout => e_dout,
