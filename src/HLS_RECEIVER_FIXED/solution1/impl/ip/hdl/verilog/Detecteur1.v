...
(* CORE_GENERATION_INFO="Detecteur1,hls_ip_2020_1,{HLS_INPUT_TYPE=sc,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100t-csg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.190000,HLS_SYN_LAT=580,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=18,HLS_SYN_FF=896,HLS_SYN_LUT=1772,HLS_VERSION=2020_1}" *)
...
wire    grp_Seuil_calc1_fu_100_e_read;
wire    grp_Seuil_calc1_fu_100_detect_din;
wire    grp_Seuil_calc1_fu_100_detect_write;
wire    grp_trames_separ1_fu_114_e_read;
wire    grp_trames_separ1_fu_114_detect_dout;
wire    grp_trames_separ1_fu_114_detect_read;
wire   [7:0] grp_trames_separ1_fu_114_s_din;
wire    grp_trames_separ1_fu_114_s_write;
...
Seuil_calc1 grp_Seuil_calc1_fu_100(
...
trames_separ1 grp_trames_separ1_fu_114(
...
assign detect_1_din = grp_Seuil_calc1_fu_100_detect_din;

assign e_read = grp_DOUBLEUR_U_fu_130_e_read;

assign grp_trames_separ1_fu_114_detect_dout = detect_1_dout;

assign s_din = grp_trames_separ1_fu_114_s_din;

assign s_write = grp_trames_separ1_fu_114_s_write;

endmodule //Detecteur1
