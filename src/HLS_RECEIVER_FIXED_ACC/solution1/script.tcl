...
add_files systemc/src/Seuil_calc2.hpp
add_files systemc/src/constantes.hpp
add_files systemc/src/my_module2.cpp -cflags "-std=c++0x"
add_files systemc/src/my_module2.hpp
add_files systemc/src/trames_separ2.hpp
open_solution "solution1"
set_part {xc7a100tcsg324-1}
create_clock -period 10 -name default
#source "./HLS_RECEIVER_FIXED_ACC/solution1/directives.tcl"
#csim_design
csynth_design
#cosim_design
