...
// ==============================================================
#ifndef __Seuil_calc2_mac_mdEe__HH__
#define __Seuil_calc2_mac_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Seuil_calc2_mac_mdEe) {
    ...
    SC_CTOR(Seuil_calc2_mac_mdEe):  simcore_mac_0_U ("simcore_mac_0_U") {
