...
ModuleCompute_do_gen::ModuleCompute_do_gen(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ModuleCompute_macg8j_U51 = new ModuleCompute_macg8j<1,1,8,8,16,16>("ModuleCompute_macg8j_U51");
    ModuleCompute_macg8j_U51->din0(grp_fu_183_p0);
    ModuleCompute_macg8j_U51->din1(grp_fu_183_p1);
    ModuleCompute_macg8j_U51->din2(grp_fu_183_p2);
    ModuleCompute_macg8j_U51->dout(grp_fu_183_p3);
    ...
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ret_V_7_fu_124_p0 );
    sensitive << ( ret_V_7_fu_124_p1 );
    ...
    SC_METHOD(thread_lhs_V_7_fu_121_p1);
    ...
    SC_METHOD(thread_ret_V_7_fu_124_p0);
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( lhs_V_7_fu_121_p1 );

    SC_METHOD(thread_ret_V_7_fu_124_p1);
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( lhs_V_7_fu_121_p1 );
    ...
    sc_trace(mVcdFile, ret_V_7_fu_124_p0, "ret_V_7_fu_124_p0");
    sc_trace(mVcdFile, lhs_V_7_fu_121_p1, "lhs_V_7_fu_121_p1");
    sc_trace(mVcdFile, ret_V_7_fu_124_p1, "ret_V_7_fu_124_p1");
...
ModuleCompute_do_gen::~ModuleCompute_do_gen() {
    ...
    delete ModuleCompute_macg8j_U51;
}
...
void ModuleCompute_do_gen::thread_grp_fu_183_p2() {
    grp_fu_183_p2 = (!ret_V_7_fu_124_p0.read().is_01() || !ret_V_7_fu_124_p1.read().is_01())? sc_lv<16>(): sc_bigint<8>(ret_V_7_fu_124_p0.read()) * sc_bigint<8>(ret_V_7_fu_124_p1.read());
}
...
void ModuleCompute_do_gen::thread_lhs_V_7_fu_121_p1() {
    lhs_V_7_fu_121_p1 = esl_sext<16,8>(val_V_3_reg_196.read());
}
...
void ModuleCompute_do_gen::thread_ret_V_7_fu_124_p0() {
    ret_V_7_fu_124_p0 =  (sc_lv<8>) (lhs_V_7_fu_121_p1.read());
}

void ModuleCompute_do_gen::thread_ret_V_7_fu_124_p1() {
    ret_V_7_fu_124_p1 =  (sc_lv<8>) (lhs_V_7_fu_121_p1.read());
}
