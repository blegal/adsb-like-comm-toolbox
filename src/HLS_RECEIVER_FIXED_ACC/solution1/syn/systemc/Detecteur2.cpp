...
const sc_logic Detecteur2::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic Detecteur2::ap_const_logic_0 = sc_dt::Log_0;

Detecteur2::Detecteur2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_Seuil_calc2_fu_100 = new Seuil_calc2("grp_Seuil_calc2_fu_100");
    grp_Seuil_calc2_fu_100->e_dout(dbl2scalc_1_dout);
    grp_Seuil_calc2_fu_100->e_empty_n(dbl2scalc_1_empty_n);
    grp_Seuil_calc2_fu_100->e_read(grp_Seuil_calc2_fu_100_e_read);
    grp_Seuil_calc2_fu_100->detect_din(grp_Seuil_calc2_fu_100_detect_din);
    grp_Seuil_calc2_fu_100->detect_full_n(detect_1_full_n);
    grp_Seuil_calc2_fu_100->detect_write(grp_Seuil_calc2_fu_100_detect_write);
    grp_Seuil_calc2_fu_100->clock(clock);
    grp_Seuil_calc2_fu_100->reset(reset);
    grp_trames_separ2_fu_114 = new trames_separ2("grp_trames_separ2_fu_114");
    grp_trames_separ2_fu_114->e_dout(dbl2tsep_1_dout);
    grp_trames_separ2_fu_114->e_empty_n(dbl2tsep_1_empty_n);
    grp_trames_separ2_fu_114->e_read(grp_trames_separ2_fu_114_e_read);
    grp_trames_separ2_fu_114->detect_dout(grp_trames_separ2_fu_114_detect_dout);
    grp_trames_separ2_fu_114->detect_empty_n(detect_1_empty_n);
    grp_trames_separ2_fu_114->detect_read(grp_trames_separ2_fu_114_detect_read);
    grp_trames_separ2_fu_114->s_din(grp_trames_separ2_fu_114_s_din);
    grp_trames_separ2_fu_114->s_full_n(s_full_n);
    grp_trames_separ2_fu_114->s_write(grp_trames_separ2_fu_114_s_write);
    grp_trames_separ2_fu_114->clock(clock);
    grp_trames_separ2_fu_114->reset(reset);
    ...
    dbl2scalc_1_fifo_U->if_read(grp_Seuil_calc2_fu_100_e_read);
    ...
    dbl2tsep_1_fifo_U->if_read(grp_trames_separ2_fu_114_e_read);
    ...
    detect_1_fifo_U->if_write(grp_Seuil_calc2_fu_100_detect_write);
    detect_1_fifo_U->if_dout(detect_1_dout);
    detect_1_fifo_U->if_empty_n(detect_1_empty_n);
    detect_1_fifo_U->if_read(grp_trames_separ2_fu_114_detect_read);

    SC_METHOD(thread_detect_1_din);
    sensitive << ( grp_Seuil_calc2_fu_100_detect_din );

    SC_METHOD(thread_e_read);
    sensitive << ( grp_DOUBLEUR_U_fu_130_e_read );

    SC_METHOD(thread_grp_trames_separ2_fu_114_detect_dout);
    sensitive << ( detect_1_dout );

    SC_METHOD(thread_s_din);
    sensitive << ( grp_trames_separ2_fu_114_s_din );

    SC_METHOD(thread_s_write);
    sensitive << ( grp_trames_separ2_fu_114_s_write );

    SC_THREAD(thread_ap_var_for_const0);

    static int apTFileNum = 0;
    stringstream apTFilenSS;
    apTFilenSS << "Detecteur2_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, grp_Seuil_calc2_fu_100_e_read, "grp_Seuil_calc2_fu_100_e_read");
    sc_trace(mVcdFile, grp_Seuil_calc2_fu_100_detect_din, "grp_Seuil_calc2_fu_100_detect_din");
    sc_trace(mVcdFile, grp_Seuil_calc2_fu_100_detect_write, "grp_Seuil_calc2_fu_100_detect_write");
    sc_trace(mVcdFile, grp_trames_separ2_fu_114_e_read, "grp_trames_separ2_fu_114_e_read");
    sc_trace(mVcdFile, grp_trames_separ2_fu_114_detect_dout, "grp_trames_separ2_fu_114_detect_dout");
    sc_trace(mVcdFile, grp_trames_separ2_fu_114_detect_read, "grp_trames_separ2_fu_114_detect_read");
    sc_trace(mVcdFile, grp_trames_separ2_fu_114_s_din, "grp_trames_separ2_fu_114_s_din");
    sc_trace(mVcdFile, grp_trames_separ2_fu_114_s_write, "grp_trames_separ2_fu_114_s_write");
...
Detecteur2::~Detecteur2() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

    delete grp_Seuil_calc2_fu_100;
    delete grp_trames_separ2_fu_114;
...
void Detecteur2::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void Detecteur2::thread_detect_1_din() {
    detect_1_din =  (sc_lv<1>) (grp_Seuil_calc2_fu_100_detect_din.read());
}

void Detecteur2::thread_e_read() {
    e_read = grp_DOUBLEUR_U_fu_130_e_read.read();
}

void Detecteur2::thread_grp_trames_separ2_fu_114_detect_dout() {
    grp_trames_separ2_fu_114_detect_dout =  (sc_logic) (detect_1_dout.read()[0]);
}

void Detecteur2::thread_s_din() {
    s_din = grp_trames_separ2_fu_114_s_din.read();
}

void Detecteur2::thread_s_write() {
    s_write = grp_trames_separ2_fu_114_s_write.read();
}
