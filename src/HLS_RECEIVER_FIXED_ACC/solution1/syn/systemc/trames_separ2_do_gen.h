...
#ifndef _trames_separ2_do_gen_HH_
#define _trames_separ2_do_gen_HH_
...
struct trames_separ2_do_gen : public sc_module {
    ...
    // Module declarations
    trames_separ2_do_gen(sc_module_name name);
    SC_HAS_PROCESS(trames_separ2_do_gen);
