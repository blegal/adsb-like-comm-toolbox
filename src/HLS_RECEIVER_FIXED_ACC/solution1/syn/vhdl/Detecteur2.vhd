...
architecture behav of Detecteur2 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "Detecteur2,hls_ip_2020_1,{HLS_INPUT_TYPE=sc,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100t-csg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.190000,HLS_SYN_LAT=580,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=3,HLS_SYN_FF=578,HLS_SYN_LUT=786,HLS_VERSION=2020_1}";
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_logic_0 : STD_LOGIC := '0';

    signal grp_Seuil_calc2_fu_100_e_read : STD_LOGIC;
    signal grp_Seuil_calc2_fu_100_detect_din : STD_LOGIC;
    signal grp_Seuil_calc2_fu_100_detect_write : STD_LOGIC;
    signal grp_trames_separ2_fu_114_e_read : STD_LOGIC;
    signal grp_trames_separ2_fu_114_detect_dout : STD_LOGIC;
    signal grp_trames_separ2_fu_114_detect_read : STD_LOGIC;
    signal grp_trames_separ2_fu_114_s_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_trames_separ2_fu_114_s_write : STD_LOGIC;
...
begin
    grp_Seuil_calc2_fu_100 : component Seuil_calc2
    port map (
        e_dout => dbl2scalc_1_dout,
        e_empty_n => dbl2scalc_1_empty_n,
        e_read => grp_Seuil_calc2_fu_100_e_read,
        detect_din => grp_Seuil_calc2_fu_100_detect_din,
        detect_full_n => detect_1_full_n,
        detect_write => grp_Seuil_calc2_fu_100_detect_write,
        clock => clock,
        reset => reset);

    grp_trames_separ2_fu_114 : component trames_separ2
    port map (
        e_dout => dbl2tsep_1_dout,
        e_empty_n => dbl2tsep_1_empty_n,
        e_read => grp_trames_separ2_fu_114_e_read,
        detect_dout => grp_trames_separ2_fu_114_detect_dout,
        detect_empty_n => detect_1_empty_n,
        detect_read => grp_trames_separ2_fu_114_detect_read,
        s_din => grp_trames_separ2_fu_114_s_din,
        s_full_n => s_full_n,
        s_write => grp_trames_separ2_fu_114_s_write,
        clock => clock,
        reset => reset);
    ...
    port map (
        ...
        if_read => grp_Seuil_calc2_fu_100_e_read);
    ...
    port map (
        ...
        if_read => grp_trames_separ2_fu_114_e_read);
    ...
    port map (
        ...
        if_write => grp_Seuil_calc2_fu_100_detect_write,
        if_dout => detect_1_dout,
        if_empty_n => detect_1_empty_n,
        if_read => grp_trames_separ2_fu_114_detect_read);




    detect_1_din <= (0=>grp_Seuil_calc2_fu_100_detect_din, others=>'-');
    e_read <= grp_DOUBLEUR_U_fu_130_e_read;
    grp_trames_separ2_fu_114_detect_dout <= detect_1_dout(0);
    s_din <= grp_trames_separ2_fu_114_s_din;
    s_write <= grp_trames_separ2_fu_114_s_write;
end behav;
