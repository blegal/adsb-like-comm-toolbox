...
architecture behav of BitDecider_do_gen is 
    ...
    signal icmp_ln37_fu_65_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln37_reg_75 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    icmp_ln37_fu_65_p2 <= "1" when (unsigned(val_V_reg_70) > unsigned(e_dout)) else "0";
