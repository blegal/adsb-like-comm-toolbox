...
#
# Generated by export_simulation on Wed Mar 24 20:57:20 CET 2021
#
################################################################################
...
'-reset_run' switch to the './my_module_2.sh' script.

./my_module_2.sh -reset_run
...
./my_module_2.sh -noclean_files

For more information on the script, please type './my_module_2.sh -help'.
