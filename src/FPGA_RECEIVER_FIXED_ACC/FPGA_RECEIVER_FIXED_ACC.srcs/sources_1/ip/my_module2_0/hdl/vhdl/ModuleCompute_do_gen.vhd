...
architecture behav of ModuleCompute_do_gen is 
    ...
    signal ret_V_7_fu_124_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal lhs_V_7_fu_121_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal ret_V_7_fu_124_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component ModuleCompute_macg8j IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ModuleCompute_macg8j_U51 : component ModuleCompute_macg8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    grp_fu_183_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(ret_V_7_fu_124_p0) * signed(ret_V_7_fu_124_p1))), 16));
    ...
    icmp_ln74_fu_158_p2 <= "1" when (unsigned(g2_fu_152_p2) > unsigned(add_ln99_reg_201)) else "0";
        lhs_V_7_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(val_V_3_reg_196),16));
    ...
    ret_V_7_fu_124_p0 <= lhs_V_7_fu_121_p1(8 - 1 downto 0);
    ret_V_7_fu_124_p1 <= lhs_V_7_fu_121_p1(8 - 1 downto 0);
